using ClinicManagement.Core.Dto.AccountDto;
...
namespace Clinic_Management.Controllers
{
    ...
    [ApiController]
    public class AccountControllerAdmin : ControllerBase
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IConfiguration _configuration;

        public AccountControllerAdmin(IUnitOfWork unitOfWork, IConfiguration configuration)
        {
